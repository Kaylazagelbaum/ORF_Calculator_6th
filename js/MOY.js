...
function colorCode() {
    ...
    if (retellScore > 0 && retellScore <= 17) {
        retellInfo.classList.add('red');
    } else if (retellScore >= 18 && retellScore <= 28) {
        retellInfo.classList.add('orange');
    } else if (retellScore >= 29 && retellScore <= 47) {
        retellInfo.classList.add('yellow');
    } else if (retellScore >= 48) {
    ...
    } else if (mazeScore >= 14 && mazeScore <= 18) {
        mazeInfo.classList.add('orange');
    } else if (mazeScore >= 19 && mazeScore <= 29) {
    ...
    if (correctScore > 0 && correctScore <= 91) {
        correctInfo.classList.add('red');
    } else if (correctScore >= 92 && correctScore <= 108) {
        correctInfo.classList.add('orange');
    } else if (correctScore >= 109 && correctScore <= 140) {
        correctInfo.classList.add('yellow');
    } else if (correctScore >= 141) {
    ...
    if (compositeScore > 0 && compositeScore <= 284) {
        compositeInfo.classList.add('red');
    } else if (compositeScore >= 285 && compositeScore <= 357) {
        compositeInfo.classList.add('orange');
    } else if (compositeScore >= 358 && compositeScore <= 460) {
        compositeInfo.classList.add('yellow');
    } else if (compositeScore >= 461) {
