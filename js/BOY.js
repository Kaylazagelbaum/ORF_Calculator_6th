...
function colorCode() {
    ...
    if (retellScore > 0 && retellScore <= 15) {
        retellInfo.classList.add('red');
    } else if (retellScore >= 16 && retellScore <= 26) {
        retellInfo.classList.add('orange');
    } else if (retellScore >= 27 && retellScore <= 42) {
        retellInfo.classList.add('yellow');
    } else if (retellScore >= 43) {
    ...
    if (mazeScore > 0 && mazeScore <= 13) {
        mazeInfo.classList.add('red');
    } else if (mazeScore >= 14 && mazeScore <= 17) {
        mazeInfo.classList.add('orange');
    } else if (mazeScore >= 18 && mazeScore <= 26) {
        mazeInfo.classList.add('yellow');
    } else if (mazeScore >= 27) {
    ...
    if (correctScore > 0 && correctScore <= 89) {
        correctInfo.classList.add('red');
    } else if (correctScore >= 90 && correctScore <= 106) {
        correctInfo.classList.add('orange');
    } else if (correctScore >= 107 && correctScore <= 138) {
        correctInfo.classList.add('yellow');
    } else if (correctScore >= 139) {
    ...
    if (compositeScore > 0 && compositeScore <= 279) {
        compositeInfo.classList.add('red');
    } else if (compositeScore >= 280 && compositeScore <= 343) {
        compositeInfo.classList.add('orange');
    } else if (compositeScore >= 344 && compositeScore <= 434) {
        compositeInfo.classList.add('yellow');
    } else if (compositeScore >= 435) {
